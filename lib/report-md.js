...
report.results = testResults => {
  ...
  testResults.results.forEach(result => {
    ...
    if (result.screenCapture) {
      output.push(`<div style="width: 200px; height: 125px;"><a href="${result.screenCapture}" target="_blank" style="background: url('${result.screenCapture}') center center no-repeat; background-size: cover; width: 200px; height: 125px; display: block;"></a></div>\n`)
    }
  ...
  output.push(`**Generated by:** [Red Van Workshop - Accessibility Tester](https://github.com/redvanworkshop/accessibility-tester)`)
